...
### misc.countcountries
Implement an algorithm that counts the number of countries represented by 
areas of the same value reachable by moving North, East, West, South finite number of steps
